  ...
  <body style="width: 100%;align-content: center;margin: auto;">
      <div style="margin: 20px;">
          <table style="margin-top: 60px !important;margin: auto;width: 100%;">
              ...
              <td colspan="6"><b style="margin-bottom:25px">${pagetype ? pagetype : "Receipt"
      }</b></td>
          </tr>
                  <tr>
                      <td><b>
        ...
        ? "-"
        : `<td><b>${user?.companyInfo?.tax === "gst" ? "GST No" : "VAT No"
        }</b></td>`
      }
        ...
        : "Customer Vat No"
            ...
            <tr>
              ...
              <td>${moment(sale?.sdate).format("DD/MM/YYYY")}</td>
              <td style="word-wrap: break-word; white-space: normal; max-width: 200px;">${sale?.inaddress || ""}</td>
              <td>
              ${sale?.deladdress == "" || sale?.deladdress?.branch == null
        ? ""
        : `
              Delivery Address: ${sale?.deladdress}`
      }</td>
              <td>${sale?.invoiceno || ""}</td>
              <td>${sale?.ldate ? moment(sale?.ldate).format("DD/MM/YYYY") : "-"
      }</td>
          ...
          <table style="margin-top: 25px !important;margin: auto;width: 100%;">
              ...
              ${path == "Service" ? "" : `<th >UNIT</th>`}
                      <td width="12%"><b>Price/Rate</b></td>
                      <td width="12%"><b>Discount</b></td>
                      <td width="12%"><b>${user?.companyInfo?.tax === "gst" ? "GST%" : "VAT%"
      }</b></td>
                      <td width="12%"><b>${user?.companyInfo?.tax === "gst" ? "GST" : "VAT"
      }</b></td>
        ...
        .map(
          (product: any) => `
            ...
            : `<td >${product?.quantity ? product?.quantity : ""
              ...
              ${path == "Service"
            ? ""
            : `<td >${product?.product?.unit ? product?.product?.unit : ""
            }</td>`}
                      <td>
                          ${product?.costprice || ""}
                      </td>
          ...
          <table style="margin-top: 25px !important;margin: auto;width: 100%;">
              <tbody style="text-align: center;">
                  <tr style="font-size: 12px;">
                      <td width="30%"></td>
                      <td width="30%"></td>
                      <td width="20%"><b>${user?.companyInfo?.tax === "gst" ? "GST" : "VAT"
      }</b></td>
                      <td width="20%"><b>
                      ${user?.companyInfo?.countryInfo?.symbol || ""
              ...
              <tbody style="text-align: center;">
                  <tr style="border: none;background: lightgray;color: black;text-align: start;font-size: 12px;">
                      <td rowspan="2" width="52%" style="border: none;height: 60px;" colspan="2" width="12%">
                          <b style="margin-left:10px; padding-top:10px;">Invoice Notes</b>
                          <p style="text-align:start; margin-left:10px; word-wrap: break-word; white-space: normal; max-width: 400px;">
                              ${sale?.quotes == null
        ? "--"
        : sale?.quotes || "--"
      }
               ...
               <br>
               <b>${user?.companyInfo?.tax === "gst" ? "Total GST" : "Total VAT"
      }</b>:${parseFloat(vatTotal?.toFixed(2))}
               <br>
               <b>Grand Total</b>:${user?.companyInfo?.countryInfo?.symbol || ""
      } ${parseFloat(sale?.total || 0).toLocaleString()}
  ...
  .col-2, .col-3 {
    width: 40%;
        ...
        ?.map((product: any, index: any) => {
          if (product?.imei?.length) {
            return `
      <table border="1">
                <tr class="bordered">
                  <th class="bordered col-1">SI NO</th>
                  <th class="bordered col-2">DESCRIPTION</th>
                  <th class="bordered col-3">IMEI NUMBER</th>
                </tr>
                ${product?.imei
                .map((item: any, imeiIndex: number) => {
                  return `
                     <table>
  <tr class="bordered">
    <td class="bordered col-1">${imeiIndex + 1}</td>
    <td class="bordered col-2">${product?.description || ""}</td>
    <td class="bordered col-3">${item || ""}</td>
  </tr>
</table>`;
                })
                .join("")}
...
const template2 = ({
  ...
  <body>
      ...
      <table>
       <tr><b><center><u>${pagetype}</u><b></center></tr>
          ...
          <tr>
              ...
              <td class="medium" style="text-align: right;line-height: 20px;">
                  ...
                  <b>Bill Date: </b>${sale?.sdate ? moment(sale?.sdate).format("DD/MM/YYYY") : "-"
    } <br><br />
                  <b> Due Date: </b>${sale?.ldate ? moment(sale?.ldate).format("DD/MM/YYYY") : "-"
    }<br><br />
              </td>
          </tr>
      </table>
      ...
      : ""
                ...
                <b>${user?.counterInfo === 101 ? "Total GST" : "Total VAT"
    }:</b>  ${vatTotal
      ? `${user?.companyInfo?.countryInfo?.symbol} ${parseFloat(vatTotal.toFixed(2)) || ""
      }`
      : ""
    }<br />
                <b>Overall Discount: </b>${Discount
      ? `${user?.companyInfo?.countryInfo?.symbol} ${parseFloat(Discount)?.toFixed(2) || 0
      }`
      : 0
    }<br />
          ...
          return `
              <table>
                <tr class="bordered">
                  ...
                  <th class="bordered">DESCRIPTION</th>
                  <th class="bordered">IMEI NUMBER</th>
                </tr>
                ${product?.imei
              .map((item: any, imeiIndex: number) => {
                return `
                      <tr class="bordered">
                        <td class="bordered">${imeiIndex + 1}</td>
  ...
  <td style="margin-top: 25px;">
   <center>
  ${user?.companyInfo?.countryInfo?.name?.toLowerCase() ===
      "united arab emirates"
      ? "This is a VAT-compliant tax invoice issued under UAE VAT Law. The recipient must account for VAT under the reverse charge mechanism if applicable."
      : "Created by Taxgoglobal Limited"
    }
  </td>
</tr>
      </table>
  ...
  <body style="width: 100%;align-content: center;margin: auto;font-family:pins, 'Segoe UI', Tahoma, sans-serif">
    <div style="margin: 20px;">
      ...
      <table style="width: 100%;
        ...
        text-transform: uppercase;
        text-decoration: underline;">
<td colspan="3"> <b  style="padding-top: 20px; padding-bottom: 20px;" >${pagetype ? pagetype : "Invoice"
    }</b></td>
</tr>
              ...
              ${customer?.bus_name ? `${customer?.bus_name} <br> ` : ""}
                ${customer?.address ? `${customer?.address} <br> ` : ""}
                  ${customer?.mobile ? `${customer?.mobile} <br> ` : ""}
                    ...
                    ${customer?.email ? `${customer?.email} <br> ` : ""}
               ${user?.companyInfo?.tax === "gst"
      ? `<b>GSTIN</b> ${customer?.vat_number || ""}<br>`
      : `${customer?.vat_number || ""} <br>`
    }
              ${sale?.deladdress
      ? `<b >Delivery Address</b></br>
              ...
              word-wrap: break-word;
              white-space: normal;
              max-width: 400px;">${sale?.deladdress}</p>
                </br>`
      : ""
    }
            </td>
            <td colspan="2" style="background-color: #febb54;
              ...
              <b>Invoice number: ${sale?.invoiceno || ""}<br>
                Issued Date:${sale?.sdate ? moment(sale?.sdate).format("DD/MM/YYYY") : "-"
    }<br>
                Due Date:${sale?.ldate ? moment(sale?.ldate).format("DD/MM/YYYY") : "-"
    }<br>
                ${sale?.reference ? `Reference: ${sale?.reference}` : ""}
            </td>
          </tr>
        </tbody>
      </table>
      <table style="margin-top: 10px !important; margin: auto; width: 100%; border-collapse: collapse;">
      <table style="margin-top: 10px !important; margin: auto; width: 100%; border-collapse: collapse;">
      <tbody style="text-align: center;">
      <tr
      style="background: black; color: white; text-align: center; font-size: 8px; text-transform: uppercase;">
      <td width="10%" style="padding: 4px;"><b>Product Name</b></td>
      <td style="height: 30px; padding: 2px;" width="10%"><b> ${user?.companyInfo?.tax === "gst" ? "HSN/SAC" : "Item Code"
    }</b></td>
      <td width="10%" style="padding: 2px;"><b>Price</b></td>
      ${path == "Service" ? "" : `<td width="10%" style="padding: 12px;"><b>Qtn</b></td>`}
      ${path == "Service" ? "" : `<td width="10%" style="padding: 12px;"><b>Unit</b></td>`}
      <td width="10%" style="padding: 20px; white-space: nowrap;"><b>Discount (Amt & %)</b></td>
      ${user?.companyInfo?.tax === "vat"
      ? `<td width="10%" style="padding: 20px; white-space: nowrap;"><b>Vat (Amt & %)</b></td>`
      : gstType
        ? `<td width="10%" style="padding: 20px; white-space: nowrap;"><b>CGST (Amt & %)</b></td>
          <td width="10%" style="padding: 20px; white-space: nowrap;"><b>SGST (Amt & %)</b></td>`
        : `<td width="10%" style="padding: 20px; white-space: nowrap;"><b>GST (Amt & %)</b></td>`
    }
       <td width="10%" style="padding: 20px;"><b>Total</b></td>
      </tr>
      ${productlist
      ?.map(
        (product: any) => `
        <tr style="font-size: 12px; border-bottom: 1px solid #ddd;">
        <td style="max-width: 100px; padding: 4px;">${product.product?.idescription} </td>
         <td style="max-width: 100px; padding: 2px;">${user?.companyInfo?.tax === "gst"
        ...
        ${path == "Service"
            ? ""
            : `<td style="max-width: 100px; padding: 12px;">
        ...
        ${path == "Service"
            ? ""
            : `<td style="max-width: 100px; padding: 12px;">
          ${product?.product?.unit ? product?.product?.unitDetails?.unit : ""}
        </td>`
          }
         <td style="max-width: 100px; padding: 20px;">
          ${product?.discount ? product?.discount : "-"}
        </td>
        ${user?.companyInfo?.tax === "vat"
            ? `<td style="padding: 20px;">${product?.incomeTaxAmount} @ ${product?.incomeTax}</td>`
            : gstType
              ? `<td style="padding: 20px;">${product?.incomeTaxAmount / 2} @ ${product?.incomeTax / 2
              }</td>
            <td style="padding: 20px;">${product?.incomeTaxAmount / 2} @ ${product?.incomeTax / 2
              }</td>`
              : `<td style="padding: 20px;">${product?.incomeTaxAmount} @ ${product?.incomeTax}</td>`
      ...
      : ""
               ...
               <div>${numberToWords(Number(sale?.total).toFixed(2)) || ""} 
               </div>
           </td>
          </tr>
          </tbody>
   ...
   <table style="margin-top: 10px !important;margin: auto;width: 100%;">
      ...
      <tr
      style="background: black;color: white;text-align: center;font-size: 8px; text-transform: uppercase;">
      <td width="20%"><b>Bank Holder Name</b></td>
      <td width="20%"><b>PAID TO/FROM</b></td>
      <td width="20%"><b>Paid Method</b></td>
  ...
  <tr class="bordered">
    ...
    <td class="bordered col-3">${item || ""}</td>
      ...
      <table style="width:100%">
        <tr style="width:100%;height:10px">
        <td style="text-align: left; line-height: 18px; padding: 20px; width: 50%">
        ${selectedBank
      ? `
            <b>Company's Bank Details</b>
            <br>
      ...
      : ""
         ...
         <td style="width:50%;height:150px;border-bottom:1px solid gray;border-top:1px solid gray;border-right:1px solid gray;border-left:1px solid gray;padding-left:120px">
            Authorised Signatory</td>
        </tr>
      </table>
...
<html lang="en">
  ...
  ${invoicearray.map(
      ...
      <tr class="information">
        <td colspan="2">
          <table class="secondpart">
            <tr>
            <td>
            <img style="width: 150px; height: 100px;" src="${API.FILE_PATH
              ...
              <td class="secondpart-data">
                ...
                Due by:${moment(sale?.ldate).format("DD/MM/YYYY")}<br/>
                ${productlist?.[0]?.incomeTax !== 0
          ? `
                ${user?.companyInfo?.tax === "gst"
            ? `GSTIN: ${user?.companyInfo?.taxno}`
    ...
    <tr class="heading">
        <th style="width: 12.5%; padding: 25px; white-space: nowrap;">Product Name</th>
        <th style="width: 15%; padding: 25px;">${user?.companyInfo?.tax === "gst" ? "HSN/SAC" : "Item Code"}</th>
        <th style="width: 15%; padding: 25px;">Rate</th>
        ${path == "Service" ? "" : `<th style="width: 12.5%;">Qtn</th>`}
        <th style="width: 12%; padding: 5px;">Discount<br>(Amt & %)</th>
        ${user?.companyInfo?.tax === "vat"
            ? `<th style="width: 12%; padding: 5px;">Vat<br>(Amt & %)</th>`
            : gstType
              ? `<th style="width: 12.5%; padding: 2px;">CGST<br>(Amt & %)</th>
                 <th style="width: 12.5%; padding: 2px;">SGST<br>(Amt & %)</th>`
              : `<th style="width: 12.5%; padding: 2px;">GST<br>(Amt & %)</th>`
        }
        <th style="width: 12.5%; padding: 5px;">Total</th>
    </tr>
    <tbody class="main-table main-table1" style="border-bottom: 1px solid black;">
        ...
        <tr class=${item?.length - 1 === index ? "lineitem" : "lineheightitem"} >
            <td style="width: 12.5%; padding: 25px;">${product?.description ? product?.description : ""}</td>
            <td style="width: 15%; padding: 25px;">${user?.companyInfo?.tax === "gst"
                ? product?.product?.hsn_code
                : product?.product?.icode
              }</td>
            <td style="width: 12.5%; padding: 25px;">${product?.costprice ? product?.costprice : ""}</td>
            ${path == "Service"
                ? ""
                : `<td style="width: 12.5%;">${product?.quantity ? product?.quantity : ""}</td>`
              }
            <td style="width: 12.5%; padding: 0px;">${product?.discount ? product?.discount : "-"}</td>
            ${user?.companyInfo?.tax === "vat"
                ? `<td style="width: 12.5%; padding: 2px;">${product?.incomeTaxAmount} @ ${product?.incomeTax}</td>`
                : gstType
                  ? `<td style="width: 12.5%; padding: 2px;">${product?.incomeTaxAmount / 2} @ ${product?.incomeTax / 2}</td>
                     <td style="width: 12.5%; padding: 2px;">${product?.incomeTaxAmount / 2} @ ${product?.incomeTax / 2}</td>`
                  : `<td style="width: 12.5%; padding: 2px;">${product?.incomeTaxAmount} @ ${product?.incomeTax}</td>`
              }
            <td style="width: 12%; padding: 5px;">${product?.total
                ? `${user?.companyInfo?.countryInfo?.symbol}${parseFloat(
                  product?.total || 0
                ).toLocaleString()}`
                : ""
  ...
  <tr>
    <td style="width: 40%; text-align: start; padding: 0;">
      <table class="page-break no-page-break">
        ...
        <tr>
          <td class="width">${user?.companyInfo?.tax === "gst" ? "Total GST:" : "Total VAT:"
          }</td>
          <td class="dataend">
            ${vatTotal
            ? `${user?.companyInfo?.countryInfo?.symbol} ${parseFloat(vatTotal.toFixed(2)) || ""
    ...
    <p class="footer-text1" style="line-height: 22px; word-wrap: break-word; white-space: normal; max-width: 300px; text-align: center; margin-left: auto; margin-right: auto;">Notes:${sale?.quotes == null ? "" : sale?.quotes || ""
        }
    </p>
    <table class="footer">
...
${invoicearray.map(
    ...
    <table class="fulltable">
        ...
        <table>
             ...
             <th style="width: 300px;">${user?.companyInfo?.tax === "gst" ? "HSN/SAC" : "Item Code"
        }</th>
    ...
    <tbody class="main-table main-table1">
        ...
        <tr class=${item?.length - 1 === index ? "lineitem" : "lineheightitem"}>
            ...
            ${user?.companyInfo?.tax === "vat"
                ...
                : gstType
                  ? `<td>${product?.incomeTaxAmount / 2} @ ${product?.incomeTax / 2
                  }</td>
                       <td>${product?.incomeTaxAmount / 2} @ ${product?.incomeTax / 2
                  }</td>`
                  : `<td>${product?.incomeTaxAmount} @ ${product?.incomeTax}</td>`
        ...
        <tr style="border-top:  1px solid black;">  
            <td rowspan="2" style="width: 431px;border-bottom:none; line-height: 22px; word-wrap: break-word; white-space: normal; max-width: 500px;">Notes: ${sale?.quotes == null ? "" : sale?.quotes || ""
        }</td>
            <td colspan="2" style="width:185px; border-bottom:none;">Taxable Value</td>
            <td style="border-bottom:none;">${netTotal
          ? `${user?.companyInfo?.countryInfo?.symbol} ${parseFloat(
            netTotal.toFixed(2)
          )}`
          : ""
        ...
        <tr style="border-top:none;">
            <td colspan="2" style="width:185px; border-bottom:none;border-top:none;">${user?.companyInfo?.tax === "gst" ? "Total GST" : "Total VAT"
        }</td>
            <td style="border-bottom:none;border-top:none;">${vatTotal
          ? `${user?.companyInfo?.countryInfo?.symbol} ${parseFloat(vatTotal.toFixed(2)) || ""
          }`
          : ""
        }</td>
        ...
        <tr style="border-top:none;">
            <td rowspan="3" style="width: 431px;border-top:none; line-height: 22px; word-wrap: break-word; white-space: normal; max-width: 500px;"><span>Terms: ${sale?.terms == null ? "" : sale?.terms || ""
        }</span></td>
            <td colspan="2" style="width: 185px; border-top: none;">Overall Discount</td>
            <td style="border-top: none;">${Discount
          ? `${user?.companyInfo?.countryInfo?.symbol} ${parseFloat(Discount)?.toFixed(2) || 0
          }`
          : "0"
        }</td>
        ...
        <table>
            ...
            : `
              Bank Name: ${selectedBank?.laccount}<br>`
                ...
                <tr><td colspan="6">${selectedBank?.accountname == "" ||
            selectedBank?.accountname == null
            ? ""
            : `Account Name : ${selectedBank?.accountname}<br />`
          }</td></tr>
...
const template6 = ({
  ...
  <head>
      ...
      <style>
          ...
          .bordered {
              border: 0.6px solid grey !important;
              background-color: white;
              font-weight: 400;
              font-size:12px
          }
  ...
  <body>
      ${productlist
      ?.map((products: any, productListIndex: any) => {
        return `<table>
          ${productListIndex === 0
            ? `<tr>
              <td>
      ...
      <table>
          ...
          <tr>
              ...
              ${user?.phonenumber ? user?.phonenumber : ""}
              <br>
              ${user?.companyInfo?.email ? user?.companyInfo?.email : ""}
              <br>
              ${user?.companyInfo?.registerno
              ? `Reg. No: ${user?.companyInfo?.registerno}`
              : ""
          ...
          ${productlist
            ?.map((product: any, index: any) => {
              let count = productlist?.length
                ? productlist[productListIndex + 1]?.length
                : 0;
              let slNo = count + (index + 1);
              return `
               <table>
          <tr class="heading">
              <td>Product Details</td>
     ...
     ${productListIndex < productlist.length - 1
          ...
          return `
              ...
              .map((item: any, imeiIndex: number) => {
                return `
                        <tr class="bordered">
                          <td class="bordered">${imeiIndex + 1}</td>
                          <td class="bordered">${product?.description || ""
                  }</td>
                          <td class="bordered">${item || ""}</td>
                        </tr>`;
              })
...
const template7 = ({
  ...
  <head>
      <meta http-equiv="Content-type" content="text/html; charset=utf-8" />
      <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
      <title>Environmental Consultant Invoice</title>
      <style>
          body {
              margin: 40px;
              font-family: Arial, sans-serif;
  ...
  <body>
      <div class="header">
         <img class="header-img"  src="${API.FILE_PATH}logo/${user?.companyInfo?.logo
          ...
          <div class="company-website">${user?.companyInfo?.bname || ""}</div>
      </div>
      ...
      <div class="invoice-details">
          <div>Invoice No: ${sale?.invoiceno}</div>
          <div>Date: ${moment(sale?.sdate).format("DD/MM/YYYY")}</div>
          <div>
              <strong>Kind Attn:</strong><br/>
              ${user?.companyInfo?.bname || ""}<br/>
              ${user?.companyInfo?.address1 || user?.companyInfo?.address2 || ""
    }<br/>
              ${user?.companyInfo?.countryInfo?.name || ""}
          </div>
      ...
      <table>
          <thead>
              <tr>
                  ...
                  <th>Details</th>
                  <th>Amount (${user?.companyInfo?.countryInfo?.currency || "AED"
    })</th>
              </tr>
          </thead>
          <tbody>
      ...
      ?.map(
        (product: any) => `
                  <tr>
                    ...
                    <td> ${user?.companyInfo?.tax === "gst" ? "GST" : "VAT"
          } : ${product?.percentage || ""}%</td>
                      <td class="amount-column">${product?.total?.toFixed(2) || "0.00"
          }</td>
                  </tr>
              `
      )
      .join("")}
              <tr class="total-row">
                  ...
                  <td class="amount-column">${sale?.total
      ? `${user?.companyInfo?.countryInfo?.symbol} ${parseFloat(
        sale?.total || 0
      ).toLocaleString()}`
      : ""
      ...
      <div class="account-details">
          ...
          <div>Account Name: ${sale?.cname || sale?.customer?.bus_name || ""
    }</div>
          <div>Account No: ${user?.companyInfo?.bankInfo?.accnum || ""}</div>
          <div>Bank Details: ${user?.companyInfo?.bankInfo?.accountname || ""
    }</div>
          <div>IBAN No: ${user?.companyInfo?.bankInfo?.ifsc || ""}</div>
          <div>TRN: ${user?.companyInfo?.taxno || ""}</div>
      </div>

      <div class="signature-section">
          <div>For ${user?.companyInfo?.bname || ""}</div>
          <div>${user?.name || ""}</div>
          <div>${user?.designation || ""}</div>
      </div>

      <div class="company-footer">
          <div>${user?.companyInfo?.address1 || user?.companyInfo?.address2 || ""
    }</div>
          <div>Tel:${user?.phonenumber ? user?.phonenumber : ""}</div>
...
<body>
    <div class="logo-container">
       <img  src="https://taxgo-v2.s3.eu-west-1.amazonaws.com/taxgo/images/1739271602021.jpg" alt="logo" class="logo"/>
        <div class="website">pgenv-consult.com</div>
    </div>
    ...
    <div class="invoice-header">
        ...
        <div>Date: ${sale?.sdate ? moment(sale?.sdate).format("DD/MM/YYYY") : ""
    }</div>
    </div>

    <div class="client-details">
        <p>Kind Attn:</p>
        <p>${customer?.bus_name || ""}<br>
        ${customer?.address || ""}</p>
    ...
    <table class="amount-table">
        <tr>
            <th>Item/Description</th>
            <th>Details</th>
            <th>Amount (${user?.companyInfo?.countryInfo?.symbol || "AED"})</th>
        </tr>
        ${productlist
      ?.map(
        (item: any) => `
             <tr>
        <td class="description-col" rowspan="2">${item?.description || ""}</td>
        <td class="details-col">${item?.details || "Sub Total"}</td>
        <td class="amount-col">${(
            parseFloat(item?.total) - parseFloat(item?.incomeTaxAmount) || 0
          ).toFixed(2)}</td>
    </tr>
    <tr>
        <td class="details-col">Vat (${item?.incomeTax}%)</td>
        <td class="amount-col">${item?.incomeTaxAmount}</td>
    </tr>
        `
      )
      .join("")}
        <tr>
        <td colspan="2" class="center-align"><strong>Total</strong></td>
        <td class="amount-col"><strong>${sale?.total}</strong></td>
    </tr>
    </table>
    ...
    <div class="account-details">
        ...
        <table class="account-details-table">
            <tr>
                <td>Account Name</td>
                <td>${selectedBank?.accountname || user?.companyInfo?.bname || ""
    }</td>
            </tr>
            <tr>
                <td>Account No</td>
                <td>${selectedBank?.accnum || ""}</td>
            </tr>
            <tr>
                <td>Bank Details</td>
                <td>${selectedBank?.laccount || ""}, ${selectedBank?.branch || ""
    }</td>
            </tr>
            <tr>
                <td>IBAN No</td>
            ...
            <tr>
                <td>TRN</td>
                <td>${user?.companyInfo?.taxno || ""}</td>
            </tr>
        </table>
    </div>

    <div class="signature-section">
        <p>For ${user?.companyInfo?.bname || "PG Environmental Consultants"}</p>
        <br/>
        <br/>
        <p>Dr Zahid Nazeer. PhD</p>
        <br/>
        <br/>
    </div>
    ...
    <div class="footer">
    <div>
        <p>+971 54 491 4833<br>
        OFF2-0113, Ras Al Khor Industrial Area 3rd,<br>
        Bur Dubai License: ${user?.companyInfo?.registerno || "1126503"}</p>
        <br/>
