...
const Salesproformatable = (props: any) => {
  ...
  // Debug permissions
  console.log("Sales Proforma Permissions:", {
    canViewSales: canViewSales(),
    canUpdateSales: canUpdateSales(),
    canDeleteSales: canDeleteSales(),
    hasAnySalesPermission: hasAnySalesPermission(),
  });
                    ...
                    <>
                      {canUpdateSales() && (
                        <div
                          ...
                          onClick={() =>
                            navigate(
                              `/usr/proforma-invoice-form/update/${data?.data?.id}`
                            )
                          }
                        >
                      ...
                      {canUpdateSales() && (
                        <div
                          ...
                          onClick={() =>
                            navigate(
                              `/usr/proforma-invoice-form/generate/${data?.data?.id}`
                            )
                          }
                        >
  ...
  const handleRowDoubleClick = (record: any) => {
    navigate(`/usr/perfoma-invoice-view/${record?.data?.id}`);
  };
