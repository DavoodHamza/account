...
const bankTemplate = ({ user,data,totalDebit,totalCredit,totalClosing ,openingBalan,openingBalance,currentDate,oneMonthAgoDate}: any) => {
...
if(openingBalance > 0){
  ...
  try {
    ...
    "
  >
    <td colspan="3">  <span>Bank Statement</span></td>
  </tr> 
            </tbody>
          </table>
          ...
          <table style="margin-top: 25px !important;margin: auto;width: 100%;">
              <tbody style="text-align: center;">
                  <tr style="background: gray;color: white;text-align: center;font-size: 12px;">
                      ...
                      <td width="12%"><b>Paid</b></td>
                      <td width="12%"><b>Recived</b></td>
                  </tr>
                  ${data
                    .map(
                      (item: any) => `
      ...
      <tbody style="text-align: center;">
          ...
          <tr style="font-size: 15px;">
              ...
              <td style="height: 10px;" width="10%"></td>
              <td style="height: 10px;" width="10%">${openingBalan}</td>
              <td style="height: 10px;" width="10%"></td> 
          </tr>
          <tr style="font-size: 15px;">
              <td style="height: 10px;" width="10%"></td>
