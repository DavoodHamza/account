        ...
        <div style="margin: 20px">
          <table style="margin-top: 60px !important; margin: auto; width: 100%">
            ...
            >
              ...
              "
            >
              <td colspan="3"><b>Staff Report</b></td>
            </tr>
      <tr
      style="
        text-align: center;
        ...
        <div style="text-align: center; margin-top: 10px"> <span></span></div>
          ...
          <tbody style="text-align: center;">
              <tr style="background: gray;color: white;text-align: center;font-size: 12px;">
                  <td><b>Name</b></td>
                  <td><b>O/S Amount</b></td>
                  <td><b>Current Month</b></td>
                  <td><b>Previous Month</b></td>
                  <td><b>Last 3 Month</b></td>
                  <td><b>Last 4 Month</b></td>
              </tr>
              ${ReportData.map((item:any) =>`
              <tr>
              <td>${item?.staff_name}</td>
              <td>${item?.totalPrice}</td>
              <td>${item?.currentMonthTotal}</td>
              <td>${item?.lastTwoMonthsTotal}</td>
              <td>${item?.lastThreeMonthsTotal}</td>
              <td>${item?.lastFourMonthsTotal}</td>
              </tr>`
            )}
          </tbody>
      </table>
