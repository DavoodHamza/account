  ...
  function Items(props: any) {
    ...
    const validateQuantity = (_:any, value:any) => {
      if (value && !/^\d+(\.\d{1,2})?$/.test(value)) {
        notification.error({
          message:`Please enter a number with up to ${props?.qSuffix?.decimalValues} decimal places`
        })
                        ...
                        <tr>
                          ...
                          {allFieldValues &&
                            ...
                            allFieldValues?.ledger !== 20835 && (
                              <td>
                                {(allFieldValues?.columns[index]?.quantity).toFixed(props?.qSuffix?.decimalValues) || "0"}
                              </td>
                            )}
